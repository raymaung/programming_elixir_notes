...
# iex> Enum.map(1..4, &"list#{&1}") |> WordlistLoader.load_from_files
...
defmodule Dictionary do
  ...
  #
  # To give the agent a blobally accessible name.
  #
...
#   # External API
  ...
  do: Agent.get(@name, &Map.get(&1, singature_of(word)))
  ...
  do: Map.update(map, singature_of(word), [word], &[word|&1])


  defp singature_of(word),
